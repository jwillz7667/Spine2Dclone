...
packages/
  ...
  mcp-server/                    # standalone headless MCP server (stdio CLI: marionette-mcp), 201 tools over the same commands (WP-M.1). Imports document-core/format/runtime-core/render-preview/atlas-pack.
