...
const CASTING: Record<string, Cast> = {
  ...
  pip: {
    voice: 'Fenrir',
    direction:
      'very fast and excitable, high energy, like a tiny motormouth cartoon pigeon delivering breaking news',
    pitchUp: 1.08,
  },
  luna: {
    voice: 'Kore',
  ...
  beans: {
    voice: 'Leda',
    direction:
      'in a tiny squeaky jittery voice, like a very small nervous but brave cartoon chihuahua',
    pitchUp: 1.12,
  },
};
...
const LINES: readonly Line[] = [
  {
    id: 'G-101',
    char: 'gunner',
    text: 'Little legs... BIG heart!',
    acting: 'as a proud excited heroic catchphrase',
  },
  {
    id: 'B-201',
    char: 'beans',
    text: 'I got it! I got it! ...I do NOT got it!',
    acting: 'straining hard then suddenly panicking',
  },
  {
    id: 'G-202',
    char: 'gunner',
    text: 'Nice try, Beans! One more round?',
    acting: 'laughing kindly',
  },
  {
    id: 'L-203',
    char: 'luna',
    text: 'Or... you could test my new invention! The Fetch-O-Matic three thousand!',
    acting: 'sly and proud, presenting an invention',
  },
  {
    id: 'P-204',
    char: 'pip',
    text: "Big news, big news! Mama Duck's eggs hatched! Three fuzzy ducklings, right down at Willow Creek!",
  },
  {
    id: 'G-205',
    char: 'gunner',
    text: 'Ducklings? Picnic at the creek! Team Gunner, roll out!',
    acting: 'rallying the team, joyful battle cry',
  },
  ...
  { id: 'L-301', char: 'luna', text: 'Aww. They are so tiny.', acting: 'melting with cuteness' },
  {
    id: 'G-302',
    char: 'gunner',
    text: 'Almost as tiny as Beans.',
    acting: 'gentle teasing chuckle',
  },
  { id: 'B-303', char: 'beans', text: 'Hey! I am travel sized.', acting: 'mock offended, proud' },
  {
    id: 'P-304',
    char: 'pip',
    text: 'Uh oh. Uh OH! The ducklings are floating away!',
    acting: 'rising panic',
  },
  {
    id: 'G-305',
    char: 'gunner',
    text: 'Duckling overboard! Team, follow that float!',
    acting: 'urgent heroic command',
  },
  {
    id: 'P-401',
    char: 'pip',
    text: 'I got this! Pigeon power!',
    acting: 'overconfident battle cry',
  },
  {
    id: 'P-402',
    char: 'pip',
    text: 'Too... heavy... abort, abort!',
    acting: 'straining with all his might, squeezed voice',
  },
  { id: 'G-403', char: 'gunner', text: 'You okay, Pip?', acting: 'caring, slightly amused' },
  {
    id: 'P-404',
    char: 'pip',
    text: 'The float is fine. My pride? Soggy.',
    acting: 'deadpan, deflated',
  },
  {
    id: 'L-405',
    char: 'luna',
    text: 'The creek bends at the old log! We can cut them off!',
    acting: 'quick thinking, urgent',
  },
  {
    id: 'L-501',
    char: 'luna',
    text: 'Fetch-O-Matic... launch the bridge!',
    acting: 'dramatic launch command',
  },
  {
    id: 'B-502',
    char: 'beans',
    text: 'A bridge! I will grab them! Tiny paws, do not fail me now!',
    acting: 'summoning all his courage',
  },
  {
    id: 'B-503',
    char: 'beans',
    text: 'So. Much. Water.',
    acting: 'frozen in terror, tiny whisper',
  },
  {
    id: 'G-504',
    char: 'gunner',
    text: 'Hang on, buddy! I got you!',
    acting: 'urgent shout while lunging',
  },
  {
    id: 'L-505',
    char: 'luna',
  ...
  { id: 'G-601', char: 'gunner', text: "I can't see a thing.", acting: 'hushed, peering into fog' },
  {
    id: 'B-602',
    char: 'beans',
    text: 'This is all my fault. My paws were too tiny. My bark is too loud...',
    acting: 'sad, sniffling, voice trembling',
  },
  {
    id: 'G-603',
    char: 'gunner',
    text: "Too loud? Beans... that's it! Your bark is not too loud. It is JUST loud enough!",
    acting: 'realization blooming into excitement',
  },
  { id: 'B-604', char: 'beans', text: 'You mean it?', acting: 'small hopeful voice' },
  {
    id: 'G-605',
    char: 'gunner',
    text: 'Bark, buddy. Bark like you mean it!',
    acting: 'warm encouraging coach',
  },
  {
    id: 'L-606',
    char: 'luna',
    text: 'The quacks came from the left! This way!',
    acting: 'sharp and certain',
  },
  { id: 'P-701', char: 'pip', text: 'Waterfall! Dead ahead!', acting: 'alarmed lookout shout' },
  {
    ...
    acting: 'calm confident leader giving the plan fast',
  },
  { id: 'L-703', char: 'luna', text: 'Double sailor knot. Done!', acting: 'crisp, professional' },
  {
    id: 'P-704',
    char: 'pip',
    text: 'Loop is on! Go, go, go!',
    acting: 'mission accomplished, urgent',
  },
  {
    id: 'B-705',
    char: 'beans',
    text: 'Three! Two! One! TUG!',
    acting: 'shouting a countdown at the top of his tiny lungs',
  },
  {
    id: 'G-706',
    char: 'gunner',
    text: 'Little legs...',
    acting: 'through gritted teeth, straining with everything he has',
  },
  ...
  { id: 'L-708', char: 'luna', text: 'You did it, Gunner!', acting: 'overjoyed, breathless' },
  {
    id: 'G-709',
    char: 'gunner',
    text: 'WE did it. All of us.',
    acting: 'humble and warm, catching his breath',
  },
  {
    id: 'P-801',
    char: 'pip',
    text: 'Extra, extra! Team Gunner saves the day!',
    acting: 'newspaper crier, celebratory',
  },
  ...
  { id: 'P-803', char: 'pip', text: 'My pride dried fast.', acting: 'happy deadpan' },
  {
    ...
    acting: 'the warm gentle moral of the story',
  },
  { id: 'L-805', char: 'luna', text: 'And always bring a good rope.', acting: 'wry topper' },
  {
    id: 'G-806',
    char: 'gunner',
    text: 'Aww. Welcome to the team.',
    acting: 'melting, chuckling softly',
  },
  {
    id: 'G-901',
    char: 'gunner',
    text: 'See you next time, pups!',
    acting: 'bright sign-off with a wink in the voice',
  },
];
...
async function ttsPcm(line: Line): Promise<Buffer> {
  ...
  const direction =
    line.acting !== undefined ? `${cast.direction}, ${line.acting}` : cast.direction;
