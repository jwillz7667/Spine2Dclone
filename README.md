...
server exposing all 172 authoring tools so an AI agent or script can build, inspect, render, and
...
packages/
  ...
  mcp-server/      # headless MCP control surface (172 tools over stdio)
