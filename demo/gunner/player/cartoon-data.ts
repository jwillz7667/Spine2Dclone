...
export const SHOTS: readonly Shot[] = [
  // ---------------- SCENE 1: MAIN TITLE ----------------
  {
    ...
    camera: {
      from: { x: 960, y: 540, zoom: 1 },
      to: { x: 960, y: 540, zoom: 1.04 },
      ease: 'inout',
    },
    actors: [],
    audio: [],
  ...
  },
  {
    ...
    props: [{ prop: 'logo', x: 960, y: 300, scale: 1.05, behavior: 'logo-drop', at: 0.8 }],
    audio: [
  ...
  },
  {
    ...
    props: [{ prop: 'logo', x: 960, y: 300, scale: 1.05 }],
        ...
        tweens: [
          {
            t0: 5.2,
            t1: 5.9,
            to: { x: 1420, y: GROUND_Y },
            ease: 'out',
            arc: 120,
            animDuring: 'freeze-shiver',
            animAfter: 'idle',
          },
        ],
      },
  ...
  },
  {
    ...
    bg: 'bg-meadow',
    camera: {
      from: { x: 1150, y: 640, zoom: 1.35 },
      to: { x: 450, y: 660, zoom: 1.3 },
      ease: 'inout',
    },
    actors: [
  ...
  },
  {
    ...
    actors: [
      ...
      { actor: 'beans', anim: 'idle', x: 1000, y: GROUND_Y, flip: true },
      {
        ...
        y: 200,
        tweens: [
          { t0: 0.1, t1: 0.8, to: { x: 1620, y: GROUND_Y - 150 }, ease: 'out', animAfter: 'talk' },
        ],
      },
    ],
    props: [
    ...
    actors: [
      {
        ...
        flip: true,
        tweens: [
          { t0: 4.6, t1: 6.2, to: { x: 2300, y: GROUND_Y }, ease: 'linear', animDuring: 'run' },
        ],
      },
      {
        actor: 'luna',
        ...
        flip: true,
        tweens: [
          { t0: 4.9, t1: 6.4, to: { x: 2300, y: GROUND_Y }, ease: 'linear', animDuring: 'run' },
        ],
      },
      {
        actor: 'pip',
  ...
  // ---------------- SCENE 3: WILLOW CREEK ----------------
  {
    ...
    actors: [
      ...
      },
      {
        ...
        flip: true,
        tweens: [
          { t0: 0.5, t1: 2.4, to: { x: 810, y: GROUND_Y - 410 }, ease: 'out', animAfter: 'hover' },
        ],
      },
    ],
    audio: [
        ...
        tweens: [
          {
            t0: 3.8,
            t1: 4.4,
            to: { x: 1210, y: WATER_Y - 40 },
            ease: 'out',
            arc: 90,
            animDuring: 'quack-hop',
            animAfter: 'bob-float',
          },
        ],
      },
  ...
  },
  {
    ...
    camera: {
      from: { x: 700, y: 600, zoom: 1.25 },
      to: { x: 600, y: 700, zoom: 1.3 },
      ease: 'inout',
    },
    actors: [
        ...
        tweens: [
          {
            t0: 0.2,
            t1: 1.2,
            to: { x: 1450, y: WATER_Y - 120 },
            ease: 'out',
            animAfter: 'lift-strain',
          },
        ],
      },
      { actor: 'duckling-1', anim: 'panic', x: 1450, y: WATER_Y - 35 },
  ...
  },
  {
    ...
    actors: [
      { actor: 'gunner', anim: 'idle', x: 700, y: GROUND_Y, flip: true },
      {
        ...
        y: 400,
        tweens: [
          { t0: 0.1, t1: 0.5, to: { x: 860, y: GROUND_Y - 300 }, ease: 'out', animAfter: 'hover' },
        ],
      },
    ...
    actors: [
      {
        ...
        y: GROUND_Y,
        flip: true,
        tweens: [{ t0: 5.0, t1: 5.4, to: { x: 460, y: GROUND_Y }, animAfter: 'run' }],
      },
      { actor: 'gunner', anim: 'run', x: 820, y: GROUND_Y, flip: true },
      { actor: 'beans', anim: 'run', x: 150, y: GROUND_Y, flip: true },
      { actor: 'pip', anim: 'fly', x: 1080, y: 460, flip: true },
  ...
  // ---------------- SCENE 5: OLD LOG BEND ----------------
  {
    ...
    actors: [
      ...
      },
      {
        ...
        flip: true,
        tweens: [
          { t0: 0.4, t1: 1.8, to: { x: 260, y: GROUND_Y }, ease: 'out', animAfter: 'crank-gadget' },
        ],
      },
      {
        actor: 'beans',
      ...
      },
      {
        ...
        flip: true,
        tweens: [
          { t0: 0.2, t1: 1.6, to: { x: 780, y: GROUND_Y - 230 }, ease: 'out', animAfter: 'hover' },
        ],
      },
    ],
  ...
  },
  {
    ...
    bg: 'bg-log-bend',
    camera: {
      from: { x: 1080, y: 620, zoom: 1.35 },
      to: { x: 1080, y: 620, zoom: 1.4 },
      ease: 'inout',
    },
    actors: [
  ...
  // ---------------- SCENE 7: WATERFALL POINT ----------------
  {
    ...
    actors: [
      ...
      },
      {
        ...
        flip: true,
        tweens: [
          { t0: 0.5, t1: 2.0, to: { x: 650, y: GROUND_Y - 240 }, ease: 'out', animAfter: 'hover' },
        ],
      },
    ],
    props: [
    ...
    actors: [
      {
        ...
        flip: true,
        tweens: [
          { t0: 0.5, t1: 4.0, to: { x: 1380, y: WATER_Y - 90 }, ease: 'inout', animAfter: 'hover' },
        ],
      },
  ...
  },
  {
    ...
    bg: 'bg-waterfall',
    camera: {
      from: { x: 900, y: 640, zoom: 1.1 },
      to: { x: 1000, y: 620, zoom: 1.15 },
      ease: 'inout',
    },
    actors: [
    ...
    actors: [
      {
        ...
        y: GROUND_Y - 10,
        tweens: [
          { t0: 0.2, t1: 1.6, to: { x: 500, y: GROUND_Y - 10 }, ease: 'out', animAfter: 'idle' },
        ],
      },
      {
        actor: 'duckling-1',
        ...
        tweens: [
          {
            t0: 1.6,
            t1: 2.4,
            to: { x: 580, y: GROUND_Y - 15 },
            ease: 'inout',
            animAfter: 'imprint-pose',
          },
        ],
      },
      {
    ...
    actors: [
      {
        ...
        y: 950,
        tweens: [
          { t0: 1.5, t1: 2.5, to: { x: 1650, y: 950 }, ease: 'out', animAfter: 'quack-hop' },
        ],
      },
    ],
    audio: [
