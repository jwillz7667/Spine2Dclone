      ...
      pages: [
        {
          ...
          height: 128,
          regions: [
            { name: 'baseTex', x: 0, y: 0, w: 64, h: 64, rotated: false, offsetX: 0, offsetY: 0, originalW: 64, originalH: 64 },
            { name: 'skinBTex', x: 64, y: 0, w: 64, h: 64, rotated: false, offsetX: 0, offsetY: 0, originalW: 64, originalH: 64 },
          ],
        },
      ],
    },
