...
server exposing all 166 authoring tools so an AI agent or script can build, inspect, render, and
...
packages/
  ...
  mcp-server/      # headless MCP control surface (166 tools over stdio)
