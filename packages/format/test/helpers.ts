...
const CODE_FAMILY: Readonly<Record<string, string>> = {
  ...
  // Stage F4 (ADR-0014).
  PHYSICS_STEP_RANGE: 'SCHEMA',
  PHYSICS_INERTIA_RANGE: 'SCHEMA',
  PHYSICS_STRENGTH_RANGE: 'SCHEMA',
  PHYSICS_DAMPING_RANGE: 'SCHEMA',
  PHYSICS_MASS_RANGE: 'SCHEMA',
  PHYSICS_MIX_RANGE: 'SCHEMA',
  PHYSICS_CHANNELS_EMPTY: 'CONSTRAINT',
  PHYSICS_CHANNEL_DUPLICATE: 'CONSTRAINT',
  PHYSICS_BONE_MISSING: 'CONSTRAINT',
  ANIM_PHYSICS_UNKNOWN: 'ANIM',
};
