...
server exposing all 160 authoring tools so an AI agent or script can build, inspect, render, and
...
packages/
  ...
  mcp-server/      # headless MCP control surface (160 tools over stdio)
